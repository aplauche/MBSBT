...
function json_load_paths( $paths ) {
	$paths[] = \MBSBT\ROOT_PATH . '/acf-json/field-groups';
	$paths[] = \MBSBT\ROOT_PATH . '/acf-json/options-pages';
	$paths[] = \MBSBT\ROOT_PATH . '/acf-json/post-types';
	$paths[] = \MBSBT\ROOT_PATH . '/acf-json/taxonomies';
...
function json_save_path_for_post_types() {
	return \MBSBT\ROOT_PATH . '/acf-json/post-types';
}
...
function json_save_path_for_field_groups() {
	return \MBSBT\ROOT_PATH . '/acf-json/field-groups';
}
...
function json_save_path_for_taxonomies() {
	return \MBSBT\ROOT_PATH . '/acf-json/taxonomies';
}
...
function json_save_path_for_option_pages() {
	return \MBSBT\ROOT_PATH . '/acf-json/options-pages';
}
